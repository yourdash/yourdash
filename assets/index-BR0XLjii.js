...
`,Xa=({children:t})=>{const r=Ve("(prefers-color-scheme: light)");let s;return Je(()=>{Fa(Ke,s,r()?"light":"dark")}),d(qa,{ref(a){var i=s;typeof i=="function"?i(a):s=a},children:t})};function He(t){var r,s,a="";if(typeof t=="string"||typeof t=="number")a+=t;else if(typeof t=="object")if(Array.isArray(t)){var i=t.length;for(r=0;r<i;r++)t[r]&&(s=He(t[r]))&&(a&&(a+=" "),a+=s)}else for(s in t)t[s]&&(a&&(a+=" "),a+=s);return a}function E(){for(var t,r,s=0,a="",i=arguments.length;s<i;s++)(t=arguments[s])&&(r=He(t))&&(a&&(a+=" "),a+=r);return a}var Wa=x("<span>");function Qa(){return f`
    ...
    `}const ie=t=>(()=>{var r=Wa();return m(r,()=>t.children),b(()=>k(r,E(Qa(),t.class))),r})();var Ya=x("<button>");const Se=f`
...
`,oe=t=>{function r(s,a){let i=[];switch(i.push(f`
        ...
        `),s){case"xs":i.push(f`
                ...
                `),a?i.push(f`
                    ...
                    `);break}return i}return(()=>{var s=Ya();return s.$$click=a=>{t.onClick(a)},m(s,(()=>{var a=N(()=>!!t.leadingIcon);return()=>a()&&d(ie,{class:Se,get children(){return t.leadingIcon}})})(),null),m(s,()=>t.children,null),m(s,(()=>{var a=N(()=>!!t.trailingIcon);return()=>a()&&d(ie,{class:Se,get children(){return t.trailingIcon}})})(),null),b(a=>{var i=E(t.class,r(t.size,t.toggled)),n=t.disabled,c=t.toggled;return i!==a.e&&k(s,a.e=i),n!==a.t&&(s.disabled=a.t=n),c!==a.a&&C(s,"data-toggled",a.a=c),a},{e:void 0,t:void 0,a:void 0}),s})()};be(["click"]);function Ja(t){let r=[];return r.push(f`
    ...
    `),t&&r.push(f`
        ...
        `),r}const M=t=>{const[r,s]=W(!1);return d(oe,{get size(){return t.size||"s"},get toggled(){return r()},onClick:()=>{t.togglable?(s(!r()),t.onClick(r())):t.onClick()},get class(){return E(Ja(t.togglable),t.class)},get disabled(){return t.disabled||!1},get leadingIcon(){return t.leadingIcon},get trailingIcon(){return t.trailingIcon},get children(){return t.children}})};var P=(t=>(t[t.vertical=0]="vertical",t[t.horizontal=1]="horizontal",t))(P||{}),Za=x("<div>");function et(t,r){let s=[];switch(s.push(f`
        background-color: rgb(${e.sys.color["outline-variant"]});
        --thickness: ${l(1)};
    `),t){case P.horizontal:switch(s.push(f`
            ...
            `),r){case"full":s.push(f`
                    ...
                    `);break;case"middle-inset":s.push(f`
                        ...
                        margin-left: ${l(16)};
                        margin-right: ${l(16)};
                    `);break}break;case P.vertical:switch(s.push(f`
                width: var(--thickness);
            `),r){case"middle-inset":s.push(f`
                    ...
                    `);break;case"full":s.push(f`
                        width: var(--thickness);
                        height: 100%;
                    `);break}break}return s}const Z=t=>(t.width==="inset"&&t.direction===P.vertical&&console.warn("A divider cannot be both vertical and inset"),(()=>{var r=Za();return b(()=>k(r,E(et(t.direction,t.width||"full")))),r})());var at=x("<div>");function tt(){let t=[];return t.push(f`
        padding-left: ${l(16)};
        padding-right: ${l(16)};
    `),t}const rt=t=>(()=>{var r=at();return m(r,()=>t.children),b(()=>k(r,E(t.class,tt()))),r})();function st(){let t=[];return t.push(f`
        ...
        border-radius: ${e.sys.shape.corner.medium["default-size"]};
    `),t}const Ge=t=>d(rt,{get class(){return E(st())},get children(){return t.children}});function lt(t){let r=[];return r.push(f`
    ...
    `),t&&r.push(f`
        ...
        `),r}const R=t=>{const[r,s]=W(!1);return d(oe,{get size(){return t.size||"s"},get toggled(){return r()},onClick:()=>{t.togglable?(s(!r()),t.onClick(r())):t.onClick()},get class(){return E(lt(t.togglable),t.class)},get disabled(){return t.disabled||!1},get leadingIcon(){return t.leadingIcon},get trailingIcon(){return t.trailingIcon},get children(){return t.children}})};function it(t){let r=[];return r.push(f`
        background-color: transparent;
        color: rgb(${e.sys.color["on-surface-variant"]});
        border-width: ${l(1)};
        border-style: solid;
    ...
    `),t&&r.push(f`
        ...
        `),r}const B=t=>{const[r,s]=W(!1);return d(oe,{get size(){return t.size||"s"},get toggled(){return r()},onClick:()=>{t.togglable?(s(!r()),t.onClick(r())):t.onClick()},get class(){return E(it(t.togglable),t.class)},get disabled(){return t.disabled||!1},get leadingIcon(){return t.leadingIcon},get trailingIcon(){return t.trailingIcon},get children(){return t.children}})};function nt(){let t=[];return t.push(f`
        background-color: transparent;
    ...
    `),t}const K=t=>d(oe,{get size(){return t.size||"s"},toggled:!1,onClick:()=>{t.onClick()},get class(){return E(nt(),t.class)},get disabled(){return t.disabled||!1},get leadingIcon(){return t.leadingIcon},get trailingIcon(){return t.trailingIcon},get children(){return t.children}});var de=x("<div>");const fe=({children:t,count:r})=>(()=>{var s=de();return m(s,t,null),m(s,r===1?(()=>{var a=de();return b(()=>k(a,f`
                        position: absolute;
                        left: calc(100% - ${l(3)});
                        top: -${l(3)};
...
`,I=t=>(()=>{var r=yt(),s=r.firstChild,a=s.firstChild,i=a.nextSibling;return Fe(r,"click",t.onClick,!0),k(r,ht),m(r,(()=>{var n=N(()=>t.leading?.type==="icon");return()=>n()&&d(ie,{class:G,get children(){return t.leading.value}})})(),s),m(r,(()=>{var n=N(()=>t.leading?.type==="image");return()=>n()&&(()=>{var c=ut();return k(c,gt),b(o=>{var u=t.leading.value,p=t.leading.alt||"";return u!==o.e&&C(c,"src",o.e=u),p!==o.t&&C(c,"alt",o.t=p),o},{e:void 0,t:void 0}),c})()})(),s),m(r,(()=>{var n=N(()=>t.leading?.type==="avatar");return()=>n()&&(()=>{var c=dt(),o=c.firstChild,u=o.nextSibling;return k(c,mt),m(o,()=>(t.leading.alt||"uk").slice(0,2)),b(p=>{var g=t.leading.value,h=t.leading.alt||"";return g!==p.e&&C(u,"src",p.e=g),h!==p.t&&C(u,"alt",p.t=h),p},{e:void 0,t:void 0}),c})()})(),s),k(s,pt),k(a,H),m(a,()=>t.labelText),k(i,ve),m(i,()=>t.supportingText),m(r,(()=>{var n=N(()=>t.trailing?.type==="icon");return()=>n()&&d(ie,{class:F,get children(){return t.trailing.value}})})(),null),m(r,(()=>{var n=N(()=>t.trailing?.type==="text");return()=>n()&&(()=>{var c=ft();return k(c,qe),m(c,()=>t.trailing.value),c})()})(),null),b(n=>{var c=t.disabled,o=t.lines||2,u=t.selected,p=t.canSelect,g=t.divider,h=t.disabled?void 0:0;return c!==n.e&&C(r,"data-disabled",n.e=c),o!==n.t&&C(r,"data-lines",n.t=o),u!==n.a&&C(r,"data-selected",n.a=u),p!==n.o&&C(r,"data-can-select",n.o=p),g!==n.i&&C(r,"data-divider",n.i=g),h!==n.n&&C(r,"tabindex",n.n=h),n},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0}),r})();be(["click"]);var vt=x("<div>");const wt=t=>(()=>{var r=vt();return m(r,()=>t.children),b(()=>k(r,f`
                & > button + button {
                    background: red;
                    width: calc(100% + 1rem);
                }
            `)),r})();var bt=x("<h1>Button Variant '<!>'"),kt=x("<h2>Filled Button (toggle, default, disabled, icon leading, icon trailing, icon trailing & leading)"),ee=x("<div>"),$t=x("<h2>Tonal Button (toggle, default, disabled, icon leading, icon trailing, icon trailing & leading)"),xt=x("<h2>Outlined Button (toggle, default, disabled, icon leading, icon trailing, icon trailing & leading)"),zt=x("<h2>Text Button (default, disabled, icon leading, icon trailing, icon trailing & leading)"),pe=x("<h3>Random Placeholder"),Ct=x('<span>UIKit Material Expressive for SolidJS | "@yourdash/uikit-mv3-solid" | Created by <a href=https://github.com/ewsgit>Ewsgit');const V=({size:t})=>d(Ge,{get children(){return[(()=>{var r=bt(),s=r.firstChild,a=s.nextSibling;return a.nextSibling,m(r,t,a),r})(),kt(),(()=>{var r=ee();return m(r,d(M,{size:t,togglable:!0,onClick:()=>{},children:"Confirm"}),null),m(r,d(M,{size:t,onClick:()=>{},children:"Confirm"}),null),m(r,d(M,{size:t,disabled:!0,onClick:()=>{},children:"Confirm"}),null),m(r,d(M,{size:t,leadingIcon:"verified",onClick:()=>{},children:"Confirm"}),null),m(r,d(M,{size:t,trailingIcon:"face",onClick:()=>{},children:"Confirm"}),null),m(r,d(M,{size:t,leadingIcon:"borg",trailingIcon:"rotate_auto",onClick:()=>{},children:"Confirm"}),null),b(()=>k(r,f`
                    display: flex;
                    gap: 0.5rem;
                    flex-wrap: wrap;
                `)),r})(),$t(),(()=>{var r=ee();return m(r,d(R,{size:t,togglable:!0,onClick:()=>{},children:"Confirm"}),null),m(r,d(R,{size:t,onClick:()=>{},children:"Confirm"}),null),m(r,d(R,{size:t,disabled:!0,onClick:()=>{},children:"Confirm"}),null),m(r,d(R,{size:t,leadingIcon:"verified",onClick:()=>{},children:"Confirm"}),null),m(r,d(R,{size:t,trailingIcon:"face",onClick:()=>{},children:"Confirm"}),null),m(r,d(R,{size:t,leadingIcon:"borg",trailingIcon:"rotate_auto",onClick:()=>{},children:"Confirm"}),null),b(()=>k(r,f`
                    display: flex;
                    gap: 0.5rem;
                    flex-wrap: wrap;
                `)),r})(),xt(),(()=>{var r=ee();return m(r,d(B,{size:t,togglable:!0,onClick:()=>{},children:"Confirm"}),null),m(r,d(B,{size:t,onClick:()=>{},children:"Confirm"}),null),m(r,d(B,{size:t,disabled:!0,onClick:()=>{},children:"Confirm"}),null),m(r,d(B,{size:t,leadingIcon:"verified",onClick:()=>{},children:"Confirm"}),null),m(r,d(B,{size:t,trailingIcon:"face",onClick:()=>{},children:"Confirm"}),null),m(r,d(B,{size:t,leadingIcon:"borg",trailingIcon:"rotate_auto",onClick:()=>{},children:"Confirm"}),null),b(()=>k(r,f`
                    display: flex;
                    gap: 0.5rem;
                    flex-wrap: wrap;
                `)),r})(),zt(),(()=>{var r=ee();return m(r,d(K,{size:t,onClick:()=>{},children:"Confirm"}),null),m(r,d(K,{size:t,disabled:!0,onClick:()=>{},children:"Confirm"}),null),m(r,d(K,{size:t,leadingIcon:"verified",onClick:()=>{},children:"Confirm"}),null),m(r,d(K,{size:t,trailingIcon:"face",onClick:()=>{},children:"Confirm"}),null),m(r,d(K,{size:t,leadingIcon:"borg",trailingIcon:"rotate_auto",onClick:()=>{},children:"Confirm"}),null),b(()=>k(r,f`
                    display: flex;
                    gap: 0.5rem;
                    flex-wrap: wrap;
                `)),r})()]}});function Mt(){return d(Xa,{get children(){return[d(V,{size:"xs"}),d(Z,{get direction(){return P.horizontal}}),d(V,{size:"s"}),d(Z,{get direction(){return P.horizontal}}),d(V,{size:"m"}),d(Z,{get direction(){return P.horizontal}}),d(V,{size:"l"}),d(Z,{get direction(){return P.horizontal}}),d(V,{size:"xl"}),d(Ge,{get children(){return[d(fe,{count:12,get children(){var t=pe();return b(()=>k(t,f`
                            background: rgb(${e.sys.color["secondary-container"]});
                            width: 16rem;
                            margin: 0;
                            padding: 0.25rem;
                        ...
                        `)),t}}),d(fe,{count:1,get children(){var t=pe();return b(()=>k(t,f`
                            ...
                            margin: 0;
                            padding: 0.25rem;
                        `)),t}})]}}),d(ct,{get children(){return[d(I,{labelText:"Heading",supportingText:"Supporting text",onClick:()=>{}}),d(I,{labelText:"Heading",supportingText:"Supporting text",leading:{type:"icon",value:"arrow_right"},onClick:()=>{}}),d(I,{labelText:"Heading",supportingText:"Supporting text",trailing:{type:"text",value:"100+"},onClick:()=>{},canSelect:!0}),d(I,{labelText:"Heading",supportingText:"Supporting text",leading:{type:"icon",value:"arrow_right"},onClick:()=>{},trailing:{type:"icon",value:"arrow_left"},selected:!0,canSelect:!0}),d(I,{labelText:"Heading",supportingText:"Supporting text",leading:{type:"avatar",value:"https://google.com/favicon.ico"},onClick:()=>{},trailing:{type:"icon",value:"arrow_left"}}),d(I,{divider:!0,labelText:"Heading",supportingText:"Supporting text",leading:{type:"avatar",value:"https://google.com/favicon.ico"},onClick:()=>{}}),d(I,{divider:!0,labelText:"Heading",supportingText:"Supporting text",leading:{type:"image",value:"https://google.com/favicon.ico"},onClick:()=>{},selected:!0,canSelect:!0}),d(I,{divider:!0,labelText:"Heading",supportingText:"Supporting text",leading:{type:"large-image",value:"https://google.com/favicon.ico"},onClick:()=>{},selected:!0,canSelect:!0}),d(I,{labelText:"Heading",supportingText:"Supporting text",leading:{type:"video",value:"https://google.com/favicon.ico"},onClick:()=>{}})]}}),d(wt,{get children(){return[d(M,{size:"l",togglable:!0,onClick:()=>{},children:"Confirm"}),d(M,{size:"l",onClick:()=>{},children:"Confirm"}),d(M,{size:"l",disabled:!0,onClick:()=>{},children:"Confirm"}),d(M,{size:"l",leadingIcon:"verified",onClick:()=>{},children:"Confirm"}),d(M,{size:"l",trailingIcon:"face",onClick:()=>{},children:"Confirm"})]}}),Ct()]}})}va(()=>d(Mt,{}),document.getElementById("root"));
