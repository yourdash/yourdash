...
`,Wa=({children:t})=>{const r=He("(prefers-color-scheme: light)");let s;return Ze(()=>{Ua(Ve,s,r()?"light":"dark")}),y(Xa,{ref(a){var n=s;typeof n=="function"?n(a):s=a},children:t})};function Ge(t){var r,s,a="";if(typeof t=="string"||typeof t=="number")a+=t;else if(typeof t=="object")if(Array.isArray(t)){var n=t.length;for(r=0;r<n;r++)t[r]&&(s=Ge(t[r]))&&(a&&(a+=" "),a+=s)}else for(s in t)t[s]&&(a&&(a+=" "),a+=s);return a}function P(){for(var t,r,s=0,a="",n=arguments.length;s<n;s++)(t=arguments[s])&&(r=Ge(t))&&(a&&(a+=" "),a+=r);return a}var Qa=z("<span>");function Ya(){return h`
    ...
    `}const ne=t=>(()=>{var r=Qa();return m(r,()=>t.children),k(()=>$(r,P(Ya(),t.class))),r})();var Ja=z("<button>");const Se=h`
    font-size: var(--icon-size);
`,ce=t=>(()=>{var r=Ja();return r.$$click=s=>{t.onClick(s)},m(r,(()=>{var s=L(()=>!!t.leadingIcon);return()=>s()&&y(ne,{class:Se,get children(){return t.leadingIcon}})})(),null),m(r,()=>t.children,null),m(r,(()=>{var s=L(()=>!!t.trailingIcon);return()=>s()&&y(ne,{class:Se,get children(){return t.trailingIcon}})})(),null),k(s=>{var a=P(t.class,h`
                    ...
                    transition:
                        ...
                        outline-color ${e.sys.motion["duration-100"]}
                            ${e.sys.motion.easing.standard.decelerate},
                        outline-width 0ms linear,
                        background-color ${e.sys.motion["duration-100"]}
                            ${e.sys.motion.easing.standard.normal},
                        ...
                        border-radius var(--border-radius-duration, ${e.sys.motion["duration-50"]})
                            ${e.sys.motion.easing.linear};
    ...
    `),t&&r.push(h`
        ...
        `),r}const f=t=>{const[r,s]=Q(!1);return y(ce,{get size(){return t.size||"s"},get toggled(){return r()},onClick:()=>{t.togglable?(s(!r()),t.onClick(r())):t.onClick()},get class(){return P(Za(t.togglable),t.class)},get disabled(){return t.disabled||!1},get leadingIcon(){return t.leadingIcon},get trailingIcon(){return t.trailingIcon},get children(){return t.children}})};var O=(t=>(t[t.vertical=0]="vertical",t[t.horizontal=1]="horizontal",t))(O||{}),et=z("<div>");function at(t,r){let s=[];switch(s.push(h`
    ...
    `),t){case O.horizontal:switch(s.push(h`
            ...
            `),r){case"middle-inset":s.push(h`
                    ...
                    `);break;case"full":s.push(h`
                        width: var(--thickness);
                        height: 100%;
                    `);break}break}return s}const ee=t=>(t.width==="inset"&&t.direction===O.vertical&&console.warn("A divider cannot be both vertical and inset"),(()=>{var r=et();return k(()=>$(r,P(at(t.direction,t.width||"full")))),r})());var tt=z("<div>");function rt(){let t=[];return t.push(h`
        padding-left: ${l(16)};
        padding-right: ${l(16)};
    `),t}const st=t=>(()=>{var r=tt();return m(r,()=>t.children),k(()=>$(r,P(t.class,rt()))),r})();function lt(){let t=[];return t.push(h`
        ...
        border-radius: ${e.sys.shape.corner.medium["default-size"]};
    `),t}const qe=t=>y(st,{get class(){return P(lt())},get children(){return t.children}});function it(t){let r=[];return r.push(h`
    ...
    `),t&&r.push(h`
        ...
        `),r}const B=t=>{const[r,s]=Q(!1);return y(ce,{get size(){return t.size||"s"},get toggled(){return r()},onClick:()=>{t.togglable?(s(!r()),t.onClick(r())):t.onClick()},get class(){return P(it(t.togglable),t.class)},get disabled(){return t.disabled||!1},get leadingIcon(){return t.leadingIcon},get trailingIcon(){return t.trailingIcon},get children(){return t.children}})};function nt(t){let r=[];return r.push(h`
        background-color: transparent;
        color: rgb(${e.sys.color["on-surface-variant"]});
        border-width: ${l(1)};
        border-style: solid;
    ...
    `),t&&r.push(h`
        ...
        `),r}const F=t=>{const[r,s]=Q(!1);return y(ce,{get size(){return t.size||"s"},get toggled(){return r()},onClick:()=>{t.togglable?(s(!r()),t.onClick(r())):t.onClick()},get class(){return P(nt(t.togglable),t.class)},get disabled(){return t.disabled||!1},get leadingIcon(){return t.leadingIcon},get trailingIcon(){return t.trailingIcon},get children(){return t.children}})};function ot(){let t=[];return t.push(h`
        background-color: transparent;
    ...
    `),t}const V=t=>y(ce,{get size(){return t.size||"s"},toggled:!1,onClick:()=>{t.onClick()},get class(){return P(ot(),t.class)},get disabled(){return t.disabled||!1},get leadingIcon(){return t.leadingIcon},get trailingIcon(){return t.trailingIcon},get children(){return t.children}});var fe=z("<div>");const pe=({children:t,count:r})=>(()=>{var s=fe();return m(s,t,null),m(s,r===1?(()=>{var a=fe();return k(()=>$(a,h`
                        position: absolute;
                        left: calc(100% - ${l(3)});
                        top: -${l(3)};
...
`,A=t=>(()=>{var r=ut(),s=r.firstChild,a=s.firstChild,n=a.nextSibling;return Ue(r,"click",t.onClick,!0),$(r,vt),m(r,(()=>{var i=L(()=>t.leading?.type==="icon");return()=>i()&&y(ne,{class:q,get children(){return t.leading.value}})})(),s),m(r,(()=>{var i=L(()=>t.leading?.type==="image");return()=>i()&&(()=>{var c=dt();return $(c,mt),k(o=>{var d=t.leading.value,p=t.leading.alt||"";return d!==o.e&&C(c,"src",o.e=d),p!==o.t&&C(c,"alt",o.t=p),o},{e:void 0,t:void 0}),c})()})(),s),m(r,(()=>{var i=L(()=>t.leading?.type==="avatar");return()=>i()&&(()=>{var c=ft(),o=c.firstChild,d=o.nextSibling;return $(c,ht),m(o,()=>(t.leading.alt||"uk").slice(0,2)),k(p=>{var g=t.leading.value,v=t.leading.alt||"";return g!==p.e&&C(d,"src",p.e=g),v!==p.t&&C(d,"alt",p.t=v),p},{e:void 0,t:void 0}),c})()})(),s),$(s,gt),$(a,G),m(a,()=>t.labelText),$(n,we),m(n,()=>t.supportingText),m(r,(()=>{var i=L(()=>t.trailing?.type==="icon");return()=>i()&&y(ne,{class:U,get children(){return t.trailing.value}})})(),null),m(r,(()=>{var i=L(()=>t.trailing?.type==="text");return()=>i()&&(()=>{var c=pt();return $(c,Xe),m(c,()=>t.trailing.value),c})()})(),null),k(i=>{var c=t.disabled,o=t.lines||2,d=t.selected,p=t.canSelect,g=t.divider,v=t.disabled?void 0:0;return c!==i.e&&C(r,"data-disabled",i.e=c),o!==i.t&&C(r,"data-lines",i.t=o),d!==i.a&&C(r,"data-selected",i.a=d),p!==i.o&&C(r,"data-can-select",i.o=p),g!==i.i&&C(r,"data-divider",i.i=g),v!==i.n&&C(r,"tabindex",i.n=v),i},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0}),r})();ke(["click"]);var wt=z("<div>");const S=t=>(()=>{var r=wt();return m(r,()=>t.children),k(s=>{var a=t.size,n=t.connected,i=h`
                ...
                &[data-connected="true"] {
                    &[data-size="xs"] {
                        ...
                        & > button {
                            &:not(:last-child):not(:active) {
                                border-top-right-radius: ${e.sys.shape.corner.small["default-size"]};
                                border-bottom-right-radius: ${e.sys.shape.corner.small["default-size"]};
                            }

                            &:not(:first-child):not(:active) {
                                border-top-left-radius: ${e.sys.shape.corner.small["default-size"]};
                                border-bottom-left-radius: ${e.sys.shape.corner.small["default-size"]};
                            }
                        }
                    }
                    ...
                    &[data-size="l"] {
                        ...
                        & > button {
                            &:not(:last-child):not(:active) {
                                border-top-right-radius: ${e.sys.shape.corner.large["default-size"]};
                                border-bottom-right-radius: ${e.sys.shape.corner.large["default-size"]};
                            }

                            &:not(:first-child):not(:active) {
                                border-top-left-radius: ${e.sys.shape.corner.large["default-size"]};
                                border-bottom-left-radius: ${e.sys.shape.corner.large["default-size"]};
                            }
                        }
                    }
                    ...
                    &[data-size="xl"] {
                        ...
                        & > button {
                            &:not(:last-child):not(:active) {
                                border-top-right-radius: ${l(20)};
                                border-bottom-right-radius: ${l(20)};
                            }

                            &:not(:first-child):not(:active) {
                                border-top-left-radius: ${l(20)};
                                border-bottom-left-radius: ${l(20)};
                            }
                        }
                    }
                }
            ...
            `;return a!==s.e&&C(r,"data-size",s.e=a),n!==s.t&&C(r,"data-connected",s.t=n),i!==s.a&&$(r,s.a=i),s},{e:void 0,t:void 0,a:void 0}),r})();var bt=z("<h1>Button Variant '<!>'"),kt=z("<h2>Filled Button (toggle, default, disabled, icon leading, icon trailing, icon trailing & leading)"),ae=z("<div>"),$t=z("<h2>Tonal Button (toggle, default, disabled, icon leading, icon trailing, icon trailing & leading)"),xt=z("<h2>Outlined Button (toggle, default, disabled, icon leading, icon trailing, icon trailing & leading)"),zt=z("<h2>Text Button (default, disabled, icon leading, icon trailing, icon trailing & leading)"),ge=z("<h3>Random Placeholder"),Ct=z('<span>UIKit Material Expressive for SolidJS | "@yourdash/uikit-mv3-solid" | Created by <a href=https://github.com/ewsgit>Ewsgit');const H=({size:t})=>y(qe,{get children(){return[(()=>{var r=bt(),s=r.firstChild,a=s.nextSibling;return a.nextSibling,m(r,t,a),r})(),kt(),(()=>{var r=ae();return m(r,y(f,{size:t,togglable:!0,onClick:()=>{},children:"Confirm"}),null),m(r,y(f,{size:t,onClick:()=>{},children:"Confirm"}),null),m(r,y(f,{size:t,disabled:!0,onClick:()=>{},children:"Confirm"}),null),m(r,y(f,{size:t,leadingIcon:"verified",onClick:()=>{},children:"Confirm"}),null),m(r,y(f,{size:t,trailingIcon:"face",onClick:()=>{},children:"Confirm"}),null),m(r,y(f,{size:t,leadingIcon:"borg",trailingIcon:"rotate_auto",onClick:()=>{},children:"Confirm"}),null),k(()=>$(r,h`
                    display: flex;
                    gap: 0.5rem;
                    flex-wrap: wrap;
                `)),r})(),$t(),(()=>{var r=ae();return m(r,y(B,{size:t,togglable:!0,onClick:()=>{},children:"Confirm"}),null),m(r,y(B,{size:t,onClick:()=>{},children:"Confirm"}),null),m(r,y(B,{size:t,disabled:!0,onClick:()=>{},children:"Confirm"}),null),m(r,y(B,{size:t,leadingIcon:"verified",onClick:()=>{},children:"Confirm"}),null),m(r,y(B,{size:t,trailingIcon:"face",onClick:()=>{},children:"Confirm"}),null),m(r,y(B,{size:t,leadingIcon:"borg",trailingIcon:"rotate_auto",onClick:()=>{},children:"Confirm"}),null),k(()=>$(r,h`
                    display: flex;
                    gap: 0.5rem;
                    flex-wrap: wrap;
                `)),r})(),xt(),(()=>{var r=ae();return m(r,y(F,{size:t,togglable:!0,onClick:()=>{},children:"Confirm"}),null),m(r,y(F,{size:t,onClick:()=>{},children:"Confirm"}),null),m(r,y(F,{size:t,disabled:!0,onClick:()=>{},children:"Confirm"}),null),m(r,y(F,{size:t,leadingIcon:"verified",onClick:()=>{},children:"Confirm"}),null),m(r,y(F,{size:t,trailingIcon:"face",onClick:()=>{},children:"Confirm"}),null),m(r,y(F,{size:t,leadingIcon:"borg",trailingIcon:"rotate_auto",onClick:()=>{},children:"Confirm"}),null),k(()=>$(r,h`
                    display: flex;
                    gap: 0.5rem;
                    flex-wrap: wrap;
                `)),r})(),zt(),(()=>{var r=ae();return m(r,y(V,{size:t,onClick:()=>{},children:"Confirm"}),null),m(r,y(V,{size:t,disabled:!0,onClick:()=>{},children:"Confirm"}),null),m(r,y(V,{size:t,leadingIcon:"verified",onClick:()=>{},children:"Confirm"}),null),m(r,y(V,{size:t,trailingIcon:"face",onClick:()=>{},children:"Confirm"}),null),m(r,y(V,{size:t,leadingIcon:"borg",trailingIcon:"rotate_auto",onClick:()=>{},children:"Confirm"}),null),k(()=>$(r,h`
                    display: flex;
                    gap: 0.5rem;
                    flex-wrap: wrap;
                `)),r})()]}});function Mt(){return y(Wa,{get children(){return[y(H,{size:"xs"}),y(ee,{get direction(){return O.horizontal}}),y(H,{size:"s"}),y(ee,{get direction(){return O.horizontal}}),y(H,{size:"m"}),y(ee,{get direction(){return O.horizontal}}),y(H,{size:"l"}),y(ee,{get direction(){return O.horizontal}}),y(H,{size:"xl"}),y(qe,{get children(){return[y(pe,{count:12,get children(){var t=ge();return k(()=>$(t,h`
                            background: rgb(${e.sys.color["secondary-container"]});
                            width: 16rem;
                            margin: 0;
                            padding: 0.25rem;
