    ...
    async __internal_startup() {
        if (!(await this.doesPathExist(this.commonPaths.RootDirectory()))) {
            try {
                ...
                this.instance.log.error(
                    "filesystem",
                    `Failed to create ${this.instance.log.addEmphasisToString(
                        this.commonPaths.RootDirectory())} directory.`
                );
            }
        } else {
            this.instance.log.info(
        ...
        if (!(await this.doesPathExist(this.commonPaths.GlobalCacheDirectory()))) {
            try {
                ...
                this.instance.log.info(
                    "filesystem",
                    `Created ${this.instance.log.addEmphasisToString(
                        this.commonPaths.GlobalCacheDirectory())} directory.`
                );
            } catch (e) {
                console.error(e);
                this.instance.log.error(
        ...
        if (!(await this.doesPathExist(this.commonPaths.TeamsDirectory()))) {
            try {
                ...
                this.instance.log.error(
                    "filesystem",
                    `Failed to create ${this.instance.log.addEmphasisToString(
                        this.commonPaths.TeamsDirectory())} directory.`
                );
            }
        } else {
            this.instance.log.info(
        ...
        if (!(await this.doesPathExist(this.commonPaths.UsersDirectory()))) {
            try {
                ...
                this.instance.log.error(
                    "filesystem",
                    `Failed to create ${this.instance.log.addEmphasisToString(
                        this.commonPaths.UsersDirectory())} directory.`
                );
            }
        } else {
            this.instance.log.info(
        ...
        if (!(await this.doesPathExist(this.commonPaths.DefaultsDirectory()))) {
            try {
                ...
                this.instance.log.error(
                    "filesystem",
                    `Failed to create ${this.instance.log.addEmphasisToString(
                        this.commonPaths.DefaultsDirectory())} directory.`
                );
            }
        } else {
            this.instance.log.info(
        ...
        if (!(await this.doesPathExist(this.commonPaths.SystemDirectory()))) {
            try {
                ...
                this.instance.log.error(
                    "filesystem",
                    `Failed to create ${this.instance.log.addEmphasisToString(
                        this.commonPaths.SystemDirectory())} directory.`
                );
            }
        } else {
            this.instance.log.info(
        ...
        if (
            ...
            this.instance.log.info(
                "filesystem",
                `Verified ${this.instance.log.addEmphasisToString(
                    path.join(this.commonPaths.DefaultsDirectory(), "userAvatar.png"))} exists.`
            );
        }
        ...
        if (
            ...
            this.instance.log.info(
                "filesystem",
                `Verified ${this.instance.log.addEmphasisToString(
                    path.join(this.commonPaths.SystemDirectory(), "loginBackground.avif"))} exists.`
            );
        }
        ...
        if (
            ...
            this.instance.log.info(
                "filesystem",
                `Verified ${this.instance.log.addEmphasisToString(
                    path.join(this.commonPaths.SystemDirectory(), "instanceLogo.png"))} exists.`
            );
        }
        ...
        if (
            ...
            this.instance.log.info(
                ...
                `Verified ${this.instance.log.addEmphasisToString(
                    path.join(
                        this.instance.filesystem.commonPaths.GlobalCacheDirectory(), "panel",
                        "invalidIcon.webp"
                    ))} exists.`
            );
        }
